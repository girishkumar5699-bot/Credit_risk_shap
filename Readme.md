...
- Features: age, income, loan amount, credit score, employment length, home ownership, etc.
...
5. **Recommendations**: Business rules based on SHAP insights
...
2. Prioritize stable employment history  
3. Limit exposure to high LoanAmount-to-Income ratios  
4. Monitor increases in delinquencies and derogatory marks  
5. Apply DTI threshold policies for additional documentation
